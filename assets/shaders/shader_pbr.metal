...
vertex PbrRasterizerData pbr_vertex(
    ...
    device PbrGlobalVertexData const& data [[buffer(bindings::globalVertexData)]]
)
{
    PbrRasterizerData out;
...
fragment half4 pbr_fragment(
    PbrRasterizerData in [[stage_in]],
    device PbrGlobalFragmentData const& data [[buffer(bindings::globalFragmentData)]],
